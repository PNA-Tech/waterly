...
<div class="row row-cols-1 row-cols-md-3 g-4 justify-content-center mb-5">
    ...
    <div class="col">
        <div class="card">
        <img src="https://github.com/Interlake-Congressional-App-Challenge/Waterly/blob/44a26b31d4d765dda9a4297f4056f079c0b8b803/static/resources/how-we-use-water.jpg?raw=true" class="card-img-top" alt="Water Bill Cover"/>
        <div class="card-body">
