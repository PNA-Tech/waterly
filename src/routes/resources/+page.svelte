...
<div class="row row-cols-1 row-cols-md-3 g-4 justify-content-center mb-5">
    <div class="col">
        <div class="card">
        <img src="https://raw.githubusercontent.com/Interlake-Congressional-App-Challenge/Waterly/main/static/resources/water-bill.jpg" class="card-img-top" alt="Water Bill Cover"/>
        <div class="card-body">
