...
<div class="row">
  <div class="col">
    <div class="card">
      <img src="/w3images/team1.jpg" alt="Test" style="width:100%" class="card-img-top"/>
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Researcher + Website Developer</p>
  ...
  <div class="col">
    <div class="card">
      <img src="/w3images/team3.jpg" alt="John" style="width:100%" class="card-img-top"/>
      <div class="card-body">
